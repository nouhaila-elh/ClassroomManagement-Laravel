                ...
                <div class="well">
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <div>
                                <iframe src="{{ url('/fichiers/projet/' . $projet_id . '/student/'.Auth::user()->id.'/'.$affected_project) }}" frameborder="0"></iframe>
                            </div>
                            @endif
                            @if($affected_project == null)
                            <div>
    ...
    <div class="panel-body">
        <div class="col-xs-12 col-md-10 col-md-offset-1">
            <div class="well">
                ...
                <iframe src="{{ url('/fichiers/projet/' . $projet_id . '/student/'.$student_id.'/'.$affected_project) }}" style="border-style: none; border-radius: 15px;border: 1px solid black; width: 100%; height:250px;" frameborder="0"></iframe>
                <form method="post" action="{{ url('/projet/'.$projet_id.'/student/'.$student_id.'/downlaodStuProjet/' .$affected_project) }}">
                ...
                @endif
                <form method="post" action="{{ url('/projet/' . $projet_id.'/student/'.$student_id)}}">
